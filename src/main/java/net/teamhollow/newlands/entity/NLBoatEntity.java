...
public class NLBoatEntity extends BoatEntity {
    private NLBoatInfo boatInfo;

    public NLBoatEntity(EntityType<? extends NLBoatEntity> type, World world, NLBoatInfo boatInfo) {
        super(type, world);
    ...
    public Packet<?> createSpawnPacket() {
        ...
        return ServerSidePacketRegistry.INSTANCE.toPacket(new Identifier(NewLands.MOD_ID, "spawn_boat"), buf);
    }

    @Override
    public void setBoatType(BoatEntity.Type type) {
        throw new UnsupportedOperationException("Tried to set the boat type of a " + NewLands.MOD_NAME + " boat");
    }
