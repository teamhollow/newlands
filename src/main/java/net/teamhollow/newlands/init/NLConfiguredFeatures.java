...
public class NLConfiguredFeatures {
    ...
    public static final ConfiguredFeature<TreeFeatureConfig, ?> TREE_MAGNOLIA = register("tree_magnolia", Feature.TREE.configure(new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.MAGNOLIA_LOG), new WeightedBlockStateProvider().addState(States.MAGNOLIA_LEAVES, 5).addState(States.FLOWERING_MAGNOLIA_LEAVES, 1), new LargeOakFoliagePlacer(UniformIntDistribution.of(2), UniformIntDistribution.of(4), 4), new LargeOakTrunkPlacer(7, 11, 0), new TwoLayersFeatureSize(0, 0, 0, OptionalInt.of(4))).ignoreVines().heightmap(Heightmap.Type.MOTION_BLOCKING).build()));
    public static final ConfiguredFeature<?, ?> TREE_MAGNOLIA_FOREST = register("tree_magnolia_forest", TREE_MAGNOLIA.decorate(ConfiguredFeatures.Decorators.SQUARE_HEIGHTMAP).decorate(Decorator.COUNT_EXTRA.configure(new CountExtraDecoratorConfig(6, 0.1F, 1))));
