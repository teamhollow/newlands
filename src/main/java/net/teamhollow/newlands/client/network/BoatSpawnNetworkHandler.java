package net.teamhollow.newlands.client.network;
...
public class BoatSpawnNetworkHandler {
	public void register() {
		ClientSidePacketRegistry.INSTANCE.register(new Identifier(NewLands.MOD_ID, "spawn_boat"), BoatSpawnNetworkHandler::accept);
	}
