...
public class Blocks {
	...
	public static final BiRegistry<RegistryObject<Block>, RegistryObject<Item>> STRIPPED_MAGNOLIA_LOG = registerBlockWithItem("stripped_magnolia_log", new Block(Block.Properties.from(net.minecraft.block.Blocks.OAK_PLANKS)), 64, CreativeTabs.BUILDING, null);
	...
	public static final BiRegistry<RegistryObject<Block>, RegistryObject<Item>> TROPICAL_PALM_FENCE_GATE = registerBlockWithItem("tropical_palm_fence_gate", new NLFenceGate(Block.Properties.from(net.minecraft.block.Blocks.OAK_FENCE)), 64, CreativeTabs.BUILDING, null);
	public static final BiRegistry<RegistryObject<Block>, RegistryObject<Item>> TROPICAL_PALM_BUTTON = registerBlockWithItem("tropical_palm_button", new NLButton(Block.Properties.from(net.minecraft.block.Blocks.OAK_FENCE)), 64, CreativeTabs.BUILDING, null);
	public static final BiRegistry<RegistryObject<Block>, RegistryObject<Item>> TROPICAL_PALM_STAIRS = registerBlockWithItem("tropical_palm_stairs", new StairsBlock(()->TROPICAL_PALM_PLANKS.getObject1().get().getDefaultState(),Block.Properties.from(net.minecraft.block.Blocks.OAK_FENCE)), 64, CreativeTabs.BUILDING, null);
	...
	public static final BiRegistry<RegistryObject<Block>, RegistryObject<Item>> TROPICAL_PALM_PRESSURE_PLATE = registerBlockWithItem("tropical_palm_pressure_plate", new NLPressurePlate(PressurePlateBlock.Sensitivity.EVERYTHING,Block.Properties.from(net.minecraft.block.Blocks.OAK_FENCE)), 64, CreativeTabs.BUILDING, null);
