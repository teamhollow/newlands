...
public class DataGenerator {
	...
	public static List<String[]> translationBlocks = Arrays.asList(
			...
			new String[]{"new_lands:polished_shorerock", "Polished Rock" },
			new String[]{"new_lands:polished_shorerock_bricks", "Polished Rock Bricks" },
			new String[]{"new_lands:chiseled_polished_shorerock", "Chiseled Polished Rock" },
